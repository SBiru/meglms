...
( function() {
	var imageDialog = function( editor, dialogType ) {
		...
		function onInputFileChangedEvent(dialog) {
			dialog.getContentElement('Upload','uploadButton').getElement().$.click();
		}
		function bindInputFileChanged(){
			var fileToUploadElement = this.getContentElement('Upload','upload');
			var inputElement = fileToUploadElement.getInputElement();
			var dialog = this;
			inputElement.on('change',function(){onInputFileChangedEvent(dialog)});
		}
		...
		return {
			...
			onShow: function() {
				...
				bindInputFileChanged.call(this);
