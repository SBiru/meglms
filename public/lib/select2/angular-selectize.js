...
(function (angular) {
  'use strict';
  var onDropdownOpen = function(dropDown,object){
    object.setValue(object.$activeOption.html()+'')
  }
  var defaultOptions = {sortField:'value',onDropdownOpen: onDropdownOpen,openOnFocus:false}
  ...
  .directive('selectize', ['$parse', '$timeout', function($parse, $timeout) {
    ...
    return {
      ...
      link: function(scope, element, attrs, ngModelCtrl) {
        var customOpts = scope.opts?scope.$parent.$eval(scope.opts):{}
        var opts = angular.extend({},defaultOptions,customOpts);
        ...
        watchModel();
        if(scope.updateFn){
          scope.updateFn(scheduleUpdate.bind(this))
        }
        ...
        function watchParentOptions() {
          scope.$parent.$watchCollection(optionsExpression, function(options) {
            if(Object.prototype.toString.call( options ) === '[object Object]')
              options = _.map(options,function(o){return o});
            newOptions = options || [];
            optionsUpdate = true;
            if (!updateTimer) {
              scheduleUpdate();
        ...
        function scheduleUpdate(optionsUpdate_) {
          if (!selectize) {
            if (!initializing) {
              initSelectize();
            }
          ...
          updateTimer = $timeout(function() {
            ...
            if (optionsUpdate || optionsUpdate_) {
              if (!optionsIsEmpty) {
