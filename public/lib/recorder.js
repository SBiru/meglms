...
var Recorder = {
  ...
  initialize: function(options){
    ...
    this.bind('initializedFlash', this.options.onFlashInitialized || this._defaultOnFlashInitialized);
    this._loadFlash();
  },
  ...
  triggerCallback: function (name, args) {
  	//console.log(name); console.log(args);
    Recorder._executeInWindowContext(function(){
  ...
  _setupFlashContainer: function(){
    ...
    this.options.flashContainer.setAttribute("style", "z-index:10000; position: fixed; left: -9999px; top: -9999px; width: 230px; height: 140px; margin-left: 10px; border-top: 6px solid rgba(128, 128, 128, 0.6); border-bottom: 6px solid rgba(128, 128, 128, 0.6); border-radius: 5px 5px; padding-bottom: 1px; padding-right: 1px;");
  ...
  _defaultOnFlashInitialized: function () {
  	return;
  },
  ...
  _checkForFlashBlock: function(){
    window.setTimeout(function(){
      if(!Recorder._initialized){
        ...
        Recorder.triggerEvent("initializedFlash");
      }
    }, 500);
  },
