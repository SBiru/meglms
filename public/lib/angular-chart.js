(function (factory) {
  ...
  return angular.module('chart.js', [])
    ...
    .factory('ChartJsFactory', ['ChartJs', '$timeout','$compile', ChartJsFactory])
  ...
  function ChartJsFactory (ChartJs, $timeout,$compile) {
      ...
      return {
        ...
        link: function (scope, elem/*, attrs */) {
          ...
          function createChart (type) {
            ...
            if (scope.legend && scope.legend !== 'false') setLegend(elem, chart,scope);
          }
    ...
    function setLegend (elem, chart,scope) {
      var $parent = elem.parent(),
          ...
          legend = $compile('<chart-legend>' + chart.generateLegend() + '</chart-legend>')(scope.$root);
